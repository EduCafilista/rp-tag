[WALKTHROUGH.md](https://github.com/user-attachments/files/31843098/WALKTHROUGH.md)
...
>  A versão do mod acompanha a do Minecraft: o `rptag-1.2.1.jar` é para **1.21.1**. Outra versão do jogo precisa de recompilação.
